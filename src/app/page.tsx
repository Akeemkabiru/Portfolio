...
export const metadata = {
  title:
    "Kabiru Akeem – Software Engineer | Next.js, TypeScript, Node.js, Express.js",
  description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Kabiru Akeem – Software Engineer, Frontend Developer, Fullstack Developer, Backend Developer Portfolio",
      },
    ],
  },
  twitter: {
